...
import (
	...
	"github.com/dmcardoso/go-expert/12-grpc/internal/database"
	"github.com/dmcardoso/go-expert/12-grpc/internal/pb"
)
...
func (c *CategoryService) GetCategory(ctx context.Context, input *pb.CategoryGetRequest) (*pb.CategoryResponse, error) {
